...
<script>
import resetSvg from "@/assets/img/reset.png";
export default {
    props: {
    ...
    methods: {
        ...
        onCloseMouseUp() {
            if (!this.isClosedAfterSuccess && this.isSuccess) return;
            if (this.closeDown) {
                this.onClose();
            }
        ...
        makeImgWithCanvas() {
            ...
            // 随机画10个图形
            for (let i = 0; i < 12; i++) {
                ctx.fillStyle = `rgb(${this.getRandom(
                    100,
                    255
                )},${this.getRandom(100, 255)},${this.getRandom(100, 255)})`;
                ctx.strokeStyle = `rgb(${this.getRandom(
                    100,
                    255
                )},${this.getRandom(100, 255)},${this.getRandom(100, 255)})`;
